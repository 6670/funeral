(function ($, window) {
    ...
    window.applyValidation(true, '#mobile', 'false', true, false, submitForm);
    window.applyValidation(true, '#destop', 'false', true, false, submitForm);
    window.applyValidation(true, '#requestCallForm', 'top', false, false, submitForm);
    window.applyValidation(true, '#contactUsForm', 'top', true, false, submitForm);
    window.applyValidation(true, '#EquityCrossSell', 'top', true, false, submitForm);
